(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://notes.samkitk.com/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://notes.samkitk.com/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://notes.samkitk.com/assets/css/just-the-docs-' + theme + ".css"
      );
    };
